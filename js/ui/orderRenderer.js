...
// ==========================================================
// MÓDULO ORDER RENDERER (v5.26.0 - PRODUCTION OS ADDED)
    ...
    const modalContent = `
        <div class="bg-white rounded-xl shadow-2xl w-full max-w-4xl max-h-[95vh] flex flex-col">
            ...
            <div class="p-4 bg-gray-100 border-t flex flex-col sm:flex-row justify-end space-y-2 sm:space-y-0 sm:space-x-4">
                ...
                <button id="productionPdfBtn" data-id="${order.id}" class="bg-slate-700 text-white font-semibold py-2 px-4 rounded-lg flex items-center justify-center gap-2 hover:bg-slate-800 transition-colors" title="Gerar Ordem de Serviço (Sem valores)">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
